      ...
      <div className="container h-full mx-auto px-5">
        <div className="grid h-full items-center gap-4 md:grid-cols-12">
          <div className="col-span-6 flex h-full flex-col items-center justify-center py-10 md:items-start md:py-20 xl:col-span-4">
            <h1 className="mb-6 text-center text-5xl text-white text-left lg:text-6xl xl:text-7xl">
              Buy, sell and collect Books.
            </h1>
            <p className="text-gray-300 mb-8 text-center text-lg md:text-left">
              The world's largest digital marketplace for book collectibles
            </p>
            <div className="flex space-x-4 mx-auto">
              <Link
                to="/"
                className="bg-purple-700 shadow-accent-volume hover:bg-accent-dark w-36 rounded-full py-3 px-8 text-center font-semibold text-white transition-all cursor-pointer"
              >
                Buy
              </Link>
              <Link
                to="/"
                className="text-purple-700 bg-white shadow-accent-volume hover:bg-accent-dark w-36 rounded-full py-3 px-8 text-center font-semibold transition-all cursor-pointer"
              >
                Sell
              </Link>
            </div>
          ...
          <div className="col-span-6 xl:col-span-8">
            <div className="relative text-center md:pl-8 md:text-right">
              ...
              <img
                src="3D_elements.png"
                className="animation-fly absolute top-0 md:-right-[10%]"
                alt="3D Image"
              />
            </div>
          </div>
